...
<head>
  <meta charset="utf-8" />
  <link rel="apple-touch-icon" sizes="76x76" href="{{ URL::asset('/assets/img/Af.png') }}">
  <link rel="icon" type="image/png" href="{{ URL::asset('/assets/img/Af.png') }}">
      ...
      <div class="logo">
        <a href="https://www.creative-tim.com" class="simple-text logo-mini">
          <div class="logo-image-small">
            <img src="{{ URL::asset('/assets/img/Af.png') }}">
          </div>
          <!-- <p>CT</p> -->
        </a>
      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">@yield('title_content')</a>
          </div>
